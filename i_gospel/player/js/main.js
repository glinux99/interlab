(function() {
        ...
        this.buffer = function() {
            ...
            this.request.onload = function() {
                ...
                ctx.decodeAudioData(this_.audioData, function(buffer) {
                    ...
                    function(e) {
                        "Erreur avec le decodeur audio Interlab Decode data" + e.err
                    });
    ...
    function createPlayer(el, info) {
        ...
        var plr = '<div class="row "><div style="background-image: url(' + info.imageSrc + ')" class="podcast__cover col-6">\
                                ...
                                <div class="podcast__meta col-6">\
                                    ...
                                    <div class="podcast__text">\
                                        ...
                                        <p class="podcast__desc" style="height: 14rem; overflow: hidden;">' + info.description + '</p>\
...
var x=1;
 ...
 for(x=0; x<6; x++){ 
    initPlayer('.i_play1'+x, {
    audioSrc: 'player/songs/2.mp3',
    imageSrc: 'player/img/2.jpg',
