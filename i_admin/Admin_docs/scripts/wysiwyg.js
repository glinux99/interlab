...
var WYSIWYG = {
	...
	Settings: function() {
		...
		// Images Directory
		this.ImagesDir = "Admin_docs/images/";
		
		// Popups Directory
		this.PopupsDir = "Admin_docs/InterlabEditorTextePub/";
		
		// CSS Directory File
		this.CSSFile = "Admin_docs/styles/wysiwyg.css";		
		...
		this.RemoveFormatConfMessage = "Effacer l insertion HTML par MS WORD  ?";
		
		// Nofication if browser is not supported by openWYSIWYG, leave it blank for no message output.
		this.NoValidBrowserMessage = "Interlab Edith n est pas supporter sur ton navigateur.";
	...
	"underline":      ['Underline',            'Souligner',          	'underline.gif',          'underline_on.gif'],
	"strikethrough":  ['Strikethrough',        'Texte Bare',      	'strikethrough.gif',      'strikethrough_on.gif'],
	"seperator":      ['',                     '',                   	'seperator.gif',          'seperator.gif'],
	"subscript":      ['Subscript',            'Indice',          	'subscript.gif',          'subscript_on.gif'],
	"superscript":    ['Superscript',          'Super Indice',        	'superscript.gif',        'superscript_on.gif'],
	"justifyleft":    ['Justifyleft',          'Centre a gauche',        	'justify_left.gif',       'justify_left_on.gif'],
	"justifycenter":  ['Justifycenter',        'centre au centre',      	'justify_center.gif',     'justify_center_on.gif'],
	"justifyright":   ['Justifyright',         'centre a droite',       	'justify_right.gif',      'justify_right_on.gif'],
	"justifyfull": 	  ['Justifyfull', 		   'Justifier tout', 			'justify_justify.gif', 	  'justify_justify_on.gif'], 
	"unorderedlist":  ['InsertUnorderedList',  'Inserez une liste',	'list_unordered.gif',     'list_unordered_on.gif'],
	"orderedlist":    ['InsertOrderedList',    'Inserez une liste ordonnee',  	'list_ordered.gif',       'list_ordered_on.gif'],
	"outdent":        ['Outdent',              'Tabulation sortant',            	'indent_left.gif',        'indent_left_on.gif'],
	"indent":         ['Indent',               'Tabulation entrant',             	'indent_right.gif',       'indent_right_on.gif'],
	"cut":            ['Cut',                  'Couper',                	'cut.gif',                'cut_on.gif'],
	"copy":           ['Copy',                 'Copier',               	'copy.gif',               'copy_on.gif'],
	"paste":          ['Paste',                'coller',              	'paste.gif',              'paste_on.gif'],
	"forecolor":      ['ForeColor',            'Coleur d avant',          	'forecolor.gif',          'forecolor_on.gif'],
	"backcolor":      ['BackColor',            'Coleur d arriere',          	'backcolor.gif',          'backcolor_on.gif'],
	"undo":           ['Undo',                 'Retour',               	'undo.gif',               'undo_on.gif'],
	"redo":           ['Redo',                 'Avant',               	'redo.gif',               'redo_on.gif'],
	"inserttable":    ['InsertTable',          'Inserer un tableau',        	'insert_table.gif',       'insert_table_on.gif'],
	"insertimage":    ['InsertImage',          'Inserer une image',        	'insert_picture.gif',     'insert_picture_on.gif'],
	"createlink":     ['CreateLink',           'Creer un lien',         	'insert_hyperlink.gif',   'insert_hyperlink_on.gif'],
	"viewSource":     ['ViewSource',           'Voir le code source',         	'view_source.gif',        'view_source_on.gif'],
	"viewText":       ['ViewText',             'Voir le Texte',           	'view_text.gif',          'view_text_on.gif'],
	"help":           ['Help',                 'Aide',               	'help.gif',               'help_on.gif'],
	"fonts":     	  ['Fonts',           	   'le font',        	'select_font.gif',        'select_font_on.gif'],
	"fontsizes":      ['Fontsizes',            'Taille',        	'select_size.gif',        'select_size_on.gif'],
	"headings":       ['Headings',             'Taille ',        	'select_heading.gif',     'select_heading_on.gif'],
	"preview":		  ['Preview', 			   'Voir avant',       	 	'preview.gif',			  'preview_on.gif'],
	"print":		  ['Print', 			   'Imprimer',       	 	 	'print.gif',			  'print_on.gif'],
	"removeformat":   ['RemoveFormat',         'Convertir en word le HTML',    	'remove_format.gif',      'remove_format_on.gif'],
	"delete":         ['Delete',               'Effacer',             	'delete.gif',     		  'delete_on.gif'],
	"save": 		  ['Save', 				   'Save document',         'save.gif', 			  'save_on.gif'],
	"return": 		  ['Return', 			   'Retour sans enregistrer', 'return.gif', 			  'return_on.gif'],
	"maximize": 	  ['Maximize', 			   'Maximiser la taille de l editeur Interlab',   'maximize.gif', 		  'maximize_on.gif']
	},
	...
	_display: function(n, settings) {
		...
		if(textarea == null) {
			alert(" Pas de zone de texte trouve avec l id donnee dans Interlab (ID: " + n + ").");
			return;
		}
	...
	execCommand: function(n, cmd, value) {
		...
		if(this.viewTextMode[n] && !cmdValid) {
			alert("Vous etes en mode Textuel. Cette fonctionnalite a ete desactiver.");
		  	return;
		} 
		...
		switch(cmd) {
			...
			// Create Link
			case "CreateLink": 
				window.open(this.config[n].PopupsDir + 'insert_hyperlink.html?wysiwyg=' + n, 'popup', 'location=0,status=0,scrollbars=0,resizable=0,width=350,height=200,top=' + popupPosition.top + ',left=' + popupPosition.left).focus();
			break;
			
			// InsertTable
			case "InsertTable": 
				window.open(this.config[n].PopupsDir + 'create_table.html?wysiwyg=' + n, 'popup', 'location=0,status=0,scrollbars=0,resizable=0,width=500,height=270,top=' + popupPosition.top + ',left=' + popupPosition.left).focus();
			break;
			...
			// Help
			case "Help":
				window.open(this.config[n].PopupsDir + 'apropos.php?wysiwyg=' + n, 'popup', 'location=0,status=0,scrollbars=0,resizable=0,width=400,height=390,top=' + popupPosition.top + ',left=' + popupPosition.left).focus();
			break;
			...
			case "Save":
			    ...
			    if(form == null) {
			    	alert("On ne peut pas Envoyer le contenu car aucun element n a ete trouve");
			    	return;
			    }
			    form.submit();
			break;
...
var WYSIWYG_Core = {
	...
	isBrowserCompatible: function() {
		...
		if ((navigator.userAgent.indexOf('Safariy') != -1 ) || !document.getElementById || !document.designMode){   
	...
	execCommand: function(n, cmd, value) {
		...
		if(WYSIWYG_Core.isFF && (cmd == "Cut" || cmd == "Paste" || cmd == "Copy")) {
			try {
				...
				if(confirm("Copier/Couper/Paste n est pas valable sous Mozilla et FireFOx. Voulez-vous plus d information a propos de ca?")) {
...
var WYSIWYG_ContextMenu = {
	...
	output: function (n) {
		...
		this.addSeperator();
		this.addItem(n, 'InsertImage', iconImage, 'Modifier les propriete de l\'image...', isImg);
		this.addItem(n, 'CreateLink', iconLink, 'Creer ou modifier le lien...', sel || isLink);
		this.addItem(n, 'RemoveNode', iconDelete, 'Effacer', true);
